...
var MultiLineSeg = function () {
    ...
    return {
        ...
        ways2: [ // numbers of rulers used while creation
            // ways can be different, for instance ways for creating arc
            [0, 1]
        ],
        editorArray2: function (lineseg, rulers) {
            return [
                [function () { },[]],
                [function () { },[]]
            ]
        ...
        getLinkPnt2: function (link, pnts, els) { var rez;
            var t=22;
